...
import { Header, UserContext, boxShadowInput, goToScreen, traductor } from './AGTools';
    ...
    return(<>
        <View style={[styles.header]}>
            <Header
                ...
                leftAction={onBack}
            />
            <Text style={[styles.headerSupTitle]}>{traductor("Scannez le QR code de fidélité")}</Text>
            <View style={[styles.qrcodeContainer]}>
                ...
                <View style={[styles.qrcodeContainer]}>
                    <View style={[styles.textContainer,boxShadowInput]}>
                        <Text style={[styles.title]}>{traductor("ID CLIENT")}</Text>
