...
export function ShoppingCart({ width = 34, height = 34, colorIcon = "#6857E5" }) {
    return (
        ...
        >
            <Path
                d="M2.8335 2.83325H5.2985C6.8285 2.83325 8.03267 4.15075 7.90517 5.66659L6.72933 19.7766C6.531 22.0857 8.35849 24.0691 10.6818 24.0691H25.7693C27.8093 24.0691 29.5943 22.3974 29.7502 20.3716L30.5152 9.74659C30.6852 7.39493 28.9002 5.48241 26.5343 5.48241H8.24517"
                stroke={colorIcon}
                strokeWidth="2.125"
                strokeMiterlimit={10}
                strokeLinecap="round"
            ...
            />
            <Path
                d="M23.0208 31.1667C23.9988 31.1667 24.7917 30.3738 24.7917 29.3958C24.7917 28.4178 23.9988 27.625 23.0208 27.625C22.0428 27.625 21.25 28.4178 21.25 29.3958C21.25 30.3738 22.0428 31.1667 23.0208 31.1667Z"
                stroke={colorIcon}
                strokeWidth="2.125"
                strokeMiterlimit={10}
                strokeLinecap="round"
            ...
            />
            <Path
                d="M11.6873 31.1667C12.6653 31.1667 13.4582 30.3738 13.4582 29.3958C13.4582 28.4178 12.6653 27.625 11.6873 27.625C10.7093 27.625 9.9165 28.4178 9.9165 29.3958C9.9165 30.3738 10.7093 31.1667 11.6873 31.1667Z"
                stroke={colorIcon}
                strokeWidth="2.125"
                strokeMiterlimit={10}
                strokeLinecap="round"
